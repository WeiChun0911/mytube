<template>
    <div class="Navigation">
        <ul>
            ...
            <li v-bind:class="{isCurrentPage: isCurrentPage(firstNumber)}" v-on:click="setCurrentPage($event)">
                {{firstNumber}}</li>
            <li v-bind:class="{isCurrentPage: isCurrentPage(secondNumber)}" v-on:click="setCurrentPage($event)">
                {{secondNumber}}</li>
            <li v-bind:class="{isCurrentPage: isCurrentPage(thirdNumber)}" v-on:click="setCurrentPage($event)">
                {{thirdNumber}}</li>
            <li v-bind:class="{isCurrentPage: isCurrentPage(forthNumber)}" v-on:click="setCurrentPage($event)">
                {{forthNumber}}</li>
            <li v-bind:class="{isCurrentPage: isCurrentPage(fifthNumber)}" v-on:click="setCurrentPage($event)">
                {{fifthNumber}}</li>
